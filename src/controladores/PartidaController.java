...
public class PartidaController {
    ...
    public void registrarPartida(String resultado, int extraJugador1, int extraJugador2) {
        ...
        if (j1 != null && j2 != null) {
            ...
            if (resultado.equals("Victoria")) {
                j1.puntaje = j1.puntaje + 20;
                j2.puntaje = j2.puntaje - 10;
            } else if (resultado.equals("Derrota")) {
                j1.puntaje = j1.puntaje - 10;
                j2.puntaje = j2.puntaje + 20;
            }

            j1.puntaje = j1.puntaje + extraJugador1;
            j2.puntaje = j2.puntaje + extraJugador2;

            principal.arbolRanking.insertar(j1);
            principal.arbolRanking.insertar(j2);

            Partida nuevaPartida = new Partida(j1, j2, resultado, extraJugador1 + extraJugador2);
    ...
    public void anularPartida(Partida partida) {
        ...
        if (partida.resultado.equals("Victoria")) {
            partida.jugador1.puntaje = partida.jugador1.puntaje - 20;
            partida.jugador2.puntaje = partida.jugador2.puntaje + 10;
        } else if (partida.resultado.equals("Derrota")) {
            partida.jugador1.puntaje = partida.jugador1.puntaje + 10;
            partida.jugador2.puntaje = partida.jugador2.puntaje - 20;
        }
